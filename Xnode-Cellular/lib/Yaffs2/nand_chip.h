...
struct nand_chip {
	...
	void (*set_ale)(struct nand_chip * this, int high); // function to set pin high low
	void (*set_cle)(struct nand_chip * this, int high); // function to set pin high low

	int (*read_cycle)(struct nand_chip * this);
