 ...
 */
typedef enum {ERROR = 0, SUCCESS = !ERROR} Status; // TUFIXDONE: Add FAIL = 0 here and comment out the def of SUCCESS and FAIL in GlobalConstants.h to avoid conflicting def
