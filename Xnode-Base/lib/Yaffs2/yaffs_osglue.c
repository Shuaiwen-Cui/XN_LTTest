...
static void *bg_gc_func(void *dummy) __attribute__((unused)); 
...
uc32 yaffsfs_CurrentTime(void)
{
	//return time(NULL);
  return 0; //you need modify here
}
...
{
	lpc_printf("ERROR: yaffs bug detected %s:%d\n", file_name, line_no);
	configASSERT(0);
}
