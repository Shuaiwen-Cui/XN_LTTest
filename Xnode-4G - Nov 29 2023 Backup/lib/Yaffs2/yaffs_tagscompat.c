				     ...
				     struct yaffs_tags *tags_ptr)
{
	...
	yaffs_do_endian_uc32(dev, &tags_stored.as_uc32[0]);
	yaffs_do_endian_uc32(dev, &tags_stored.as_uc32[1]);
...
static int yaffs_tags_compat_wr(struct yaffs_dev *dev,
			 int nand_chunk,
			 const uc8 *data, const struct yaffs_ext_tags *ext_tags)
{
	struct yaffs_spare spare;
...
static int yaffs_tags_compat_rd(struct yaffs_dev *dev,
			 int nand_chunk,
			 uc8 *data, struct yaffs_ext_tags *ext_tags)
{
	struct yaffs_spare spare;
	struct yaffs_tags tags;
