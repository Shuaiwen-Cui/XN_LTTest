...
//  LPC_SCU->SFSPE_12 = EMC_PIN_SET | 3;  /* PE_12: D31                         */
  ...
  /* Set Address mapping: 256Mb(16Mx16), 4 banks, row len = 13, column len = 9 */
  ...
  LPC_EMC->DYNAMICRAS        = EMC_NANOSEC (44, SystemCoreClock, div);
  LPC_EMC->DYNAMICSREX       = EMC_NANOSEC (80, SystemCoreClock, div);
  LPC_EMC->DYNAMICAPR        = EMC_NANOSEC (35, SystemCoreClock, div);
  LPC_EMC->DYNAMICDAL        = EMC_NANOSEC (80, SystemCoreClock, div);
  LPC_EMC->DYNAMICWR         = EMC_NANOSEC (40, SystemCoreClock, div);
  LPC_EMC->DYNAMICRC         = EMC_NANOSEC (70, SystemCoreClock, div);
  LPC_EMC->DYNAMICRFC        = EMC_NANOSEC (70, SystemCoreClock, div);
  LPC_EMC->DYNAMICXSR        = EMC_NANOSEC (80, SystemCoreClock, div);
  LPC_EMC->DYNAMICRRD        = EMC_NANOSEC (170, SystemCoreClock, div);
  LPC_EMC->DYNAMICMRD        = EMC_NANOSEC (40, SystemCoreClock, div);
