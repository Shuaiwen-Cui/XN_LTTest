...
#define PARAM_UART_DATABIT(databit)	((databit==UART_DATABIT_5) || (databit==UART_DATABIT_6) || (databit==UART_DATABIT_7) || (databit==UART_DATABIT_8))
...
#define PARAM_UART_PARITY(parity)	((parity==UART_PARITY_NONE) || (parity==UART_PARITY_ODD) || (parity==UART_PARITY_EVEN) || (parity==UART_PARITY_SP_1) || (parity==UART_PARITY_SP_0))

/** Macro to check the input UART_FIFO parameters */
#define PARAM_UART_FIFO_LEVEL(fifo)	((fifo==UART_FIFO_TRGLEV0) || (fifo==UART_FIFO_TRGLEV1) || (fifo==UART_FIFO_TRGLEV2) || (fifo==UART_FIFO_TRGLEV3))

/** Macro to check the input UART_INTCFG parameters */
#define PARAM_UART_INTCFG(IntCfg)	((IntCfg==UART_INTCFG_RBR) || (IntCfg==UART_INTCFG_THRE) || (IntCfg==UART_INTCFG_RLS) || (IntCfg==UART_INTCFG_ABEO) || (IntCfg==UART_INTCFG_ABTO))
...
#define PARAM_UART_IrDA_PULSEDIV(PulseDiv)	((PulseDiv==UART_IrDA_PULSEDIV2) || (PulseDiv==UART_IrDA_PULSEDIV4) || (PulseDiv==UART_IrDA_PULSEDIV8) || (PulseDiv==UART_IrDA_PULSEDIV16) || (PulseDiv==UART_IrDA_PULSEDIV32) || (PulseDiv==UART_IrDA_PULSEDIV64) || (PulseDiv==UART_IrDA_PULSEDIV128) || (PulseDiv==UART_IrDA_PULSEDIV256))
...
#define PARAM_UART1_MODEM_MODE(x) ((x==UART1_MODEM_MODE_LOOPBACK) || (x==UART1_MODEM_MODE_AUTO_RTS) || (x==UART1_MODEM_MODE_AUTO_CTS))
...
#define PARAM_UARTx(x)	((((uint32_t *)x)==((uint32_t *)LPC_USART0)) || (((uint32_t *)x)==((uint32_t *)LPC_UART1)) || (((uint32_t *)x)==((uint32_t *)LPC_USART2)) || (((uint32_t *)x)==((uint32_t *)LPC_USART3)))
...
void UART_ConfigStructInit(UART_CFG_Type *UART_InitStruct, int baud);
...
uint32_t UART_Send(LPC_USARTn_Type *UARTx, uint8_t *txbuf, uint32_t buflen, TRANSFER_BLOCK_Type flag, bool iswait);
